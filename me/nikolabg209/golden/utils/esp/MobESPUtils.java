		...
		RenderGlobal.drawOutlinedBoundingBox(
				new AxisAlignedBB(
						...
						entity.boundingBox.maxZ
							+0.05
							- entity.posZ
							+ (entity.posZ - Minecraft.getMinecraft().getRenderManager().renderPosZ)), ColorUtils.getRainbow(4, 0.8f, 1));
		} else {
			RenderGlobal.drawOutlinedBoundingBox(
					new AxisAlignedBB(
							entity.boundingBox.minX
							...
							entity.boundingBox.maxZ
								+0.05
								- entity.posZ
								+ (entity.posZ - Minecraft.getMinecraft().getRenderManager().renderPosZ)), 0xff0000);
